    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val productAdapter = ProductAdapter(
            ...
            onProductBought = { product ->
                // Send broadcast when product is marked as bought
                val intent = Intent("PRODUCT_BOUGHT_ACTION")
        ...
        productAdapter.setCallbacks(onBoughtClick, onDownvoteClick, onProductBought)
